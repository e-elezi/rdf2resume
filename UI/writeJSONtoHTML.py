    ...
    text = r'''
            ...
            <section rel="my0:aboutPerson" typeof="my0:Person" class="resume-section p-3 p-lg-5 d-column" id="about">
                <div class="row my-auto pt-5">
                    ...
                    <p property="my0:personLongDescription" class="col-12 ofsset-12 col-md-8 offset-md-2 text-center mb-5 pt-3">''' + getValueFromLang(aboutData['my0:personLongDescription'], lang) + r'''
                    </p>
